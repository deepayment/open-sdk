...
c, err := deepayment.NewClient(deepayment.Config{
    BaseURL:                     "https://panama.deepayment.com",     // 生产环境域名；不带 /api/v1
...
if wh.Status == "FAILED" && wh.Failure != nil {
    ...
    case deepayment.MsgChannelError:        // 订单可能已生成，用 merchantOrderNo 查询，不要换新号重发
    case deepayment.MsgOrderRejected:       // 风控/业务拒绝
